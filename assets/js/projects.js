...
const projects = [
  ...
  },
  {
    ...
    category: 'computer-vision',
    status: 'completed',
    description: 'Deteksi penyakit cabai dengan YOLO11n + TensorRT FP16 di Jetson Nano. Sensor kelembaban tanah dan dashboard Flask real-time.',
  ...
  },
  {
    ...
    category: 'ai-data-science',
    status: 'solo',
    description: 'Deteksi transaksi penipuan keuangan dengan Logistic Regression dan imbalance handling. Streamlit prediction app.',
  ...
  },
  {
    ...
    category: 'web-dev',
    status: 'live',
    description: 'CMS artikel dengan AI Writer, caption generator, dan smart summary powered by Google Gemini API. PHP Native + AJAX.',
  ...
  },
  {
    ...
    category: 'mobile',
    status: 'live',
    description: 'Asisten digital petani Indonesia — cuaca 7 hari, info hama, kalender tanam, forum komunitas. Flutter + Supabase + OpenWeatherMap.',
  ...
  },
  {
    ...
    category: 'web3-iot',
    status: 'completed',
    description: 'Platform voting terdesentralisasi berbasis blockchain. Smart contract Solidity, frontend Web3.js.',
